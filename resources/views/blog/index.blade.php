...
@section('content')
<div class="w-4/5 m-auto mb-10 text-center">
...
<div class="sm:grid grid-cols-2 w-4/5 mx-auto gap-y-9 gap-x-8 auto-cols-max"> {{--  list all the blogs --}} 
    @foreach ($posts as $post)
        <div class="w-full sm:mb-10 mx-auto"> 
            ...
            <div class="w-full border-r border-b border-l border-gray-400 lg:border-gray-400 bg-white rounded-b-xl lg:rounded-b-xl p-4 flex flex-col leading-normal">
                ...
                <div class="mb-3">
                    <span class="text-gray-500 mb-3 text-s mr-6 truncate">
